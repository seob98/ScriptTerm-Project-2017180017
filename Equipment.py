class Equipment:
    ...
    def CheckItemGrade(self):
        ...
        if self.ItemLv == Equipment.Equip_1302.get(self.EnhanceLv):
            ...
            print("아이템 레벨과 강화 상태가 기존 장비 등급에 매칭되지 않습니다.")
    ...
    def GetArmorRequiredHoningMat_1340(self):
        ...
        AdditionalHoingMat = {}
        if self.EnhanceLv in [6,7,8]:
            HoningMat['수호석 결정'] = 404
            HoningMat['위대한 명예의 돌파석'] = 10
            HoningMat['중급 오레하 융화제'] = 6
            HoningMat['명예의 파편'] = 108
        elif self.EnhanceLv in [9,10,11]:
            HoningMat['수호석 결정'] = 498
            HoningMat['위대한 명예의 돌파석'] = 10
            HoningMat['중급 오레하 융화제'] = 8
            HoningMat['명예의 파편'] = 132
        elif self.EnhanceLv in [12,13,14]:
            HoningMat['수호석 결정'] = 592
            HoningMat['위대한 명예의 돌파석'] = 12
            HoningMat['중급 오레하 융화제'] = 8
            HoningMat['명예의 파편'] = 158
        elif self.EnhanceLv >= 15:
            HoningMat['계승'] = 1
